...
def modul_2():
    ...
    def setengah_interval(X1,X2):
        ...
        while(error > 0.001):
            iterasi +=1
            FXi = (float32(-0.0824*X1)**3)+(float32(2.068*X1)**2)+(float32(-9.441*X1))+(float32(-22.06))
            FXii = (float32(-0.0824*X2)**3)+(float32(2.068*X2)**2)+(float32(-9.441*X2))+(float32(-22.06))
            Xt = (float32(X1 + X2)/2)
            FXt = (float32(-0.0824*Xt)**3)+(float32(2.068*Xt)**2)+(float32(-9.441*Xt))+(float32(-22.06))
            if FXi * FXt > 0:
                X1 = Xt
            elif FXi * FXt < 0:
                X2 = Xt
    ...
    def interpolasi_linier(X1,X2):
        ...
        while(error > 0.001):
            iterasi +=1
            FX1 = (float32(-0.0824*X1)**3)+(float32(2.068*X1)**2)+(float32(-9.441*X1))+(float32(-22.06))
            FX2 = (float32(-0.0824*X2)**3)+(float32(2.068*X2)**2)+(float32(-9.441*X2))+(float32(-22.06))
    ...
    def newton_raphson(X1):
        print(" =========================================================\n",
              "Modul 2 Akar-Akar Persamaan: Metode Newton-Raphson\n",
              "KELOMPOK 10 \n",
              "OSEANOGRAFI 2019 \n",
              "PRAKTIKUM METODE NUMERIK 2021 \n"
              "=========================================================\n")
        ...
        while (akar > 0.001):
            iterasi += 1
            Fxn = (float32(-0.0824*X1)**3)+(float32(2.068*X1)**2)-(float32(-9.441*X1))+(float32(-22.06))
            Fxxn = (float32(-0.0824*3*X1)**2)+(float32(2.068*2*X1)**2)-(float32(-9.441*X1))
            xnp1 = (double(X1 - (Fxn/Fxxn)))
            fxnp1 = (float32(-0.0824*X1)**3)+(float32(2.068*X1)**2)+(float32(-9.441*X1))+(float32(-22.06))
    ...
    def secant(X1,X2):
        ...
        while(error > 0.001):
            iterasi +=1
            FX1 = (float32(-0.0824*X1)**3)+(float32(2.068*X1)**2)+(float32(-9.441*X1))+(float32(-22.06))
            FXmin = (float32(-0.0824*X2)**3)+(float32(2.068*X2)**2)+(float32(-9.441*X2))+(float32(-22.06))
            X3 = X1 - (single(FX1))*(single(X1-(X2)))/(single(FX1)-(FXmin))
            FXplus = (float32(-0.0824*Xt)**3)+(float32(2.068*Xt)**2)+(float32(-9.441*Xt))+(float32(-22.06))
            if FXplus < 0:
                error = FXplus * (-1)
            else:
                error = FXplus
    ...
    def iterasi(X1):
        ...
        while (error > 0.001):
            iterasi +=1
            Fxn = (float32(-0.0824*X1)**3)+(float32(2.068*X1)**2)+(float32(-9.441*X1))+(float32(-22.06))
            X2 = (float32(-0.0824*X2)**3)+(float32(2.068*X2)**2)+(float32(-9.441*X2))+(float32(-22.06))
    ...
    if (setting == 1):
        X1 = (float32(input("Masukkan Nilai Pertama: "))) # Untuk X1 dapat diisi 10
        X2 = (float32(input("Masukkan Nilai Kedua: "))) # Untuk X2 dapat diisi -10
...
def modul_4():
    ...
    def trapesium_1pias():
        print(" ================================================ \n",
              "Modul 4 Integrasi Numerik: Metode Trapesium 1 Pias \n",
              "KELOMPOK 10 \n",
              "OSEANOGRAFI 2019 \n",
              "PRAKTIKUM METODE NUMERIK 2021 \n"
              "================================================ \n")
        ...
        plt.savefig('C:/Kelompok 10/Images/Trapesium 1 Pias.png')
        L = 0.5*(fx2 + fx1)*(x2 - x1)
    ...
    def simpson3per8(x0,xn,n):
        print(" ================================================ \n",
              "Modul 4 Integrasi Numerik: Metode Simpson 3/8 \n",
              "KELOMPOK 10 \n",
              "OSEANOGRAFI 2019 \n",
              "PRAKTIKUM METODE NUMERIK 2021 \n"
              "================================================ \n")
    ...
    if (setting == 1):
        ...
        print(" ================================================ \n",
              "Modul 4 Integrasi Numerik: Metode Trapesium Banyak Pias \n",
              "KELOMPOK 10 \n",
              "OSEANOGRAFI 2019 \n",
              "PRAKTIKUM METODE NUMERIK 2021 \n"
              "================================================ \n")
        ...
        plt.savefig('C:/Kelompok 10/Images/Trapesium Banyak Pias.png')
        L = trapesium_banyakpias(f,a,b,N)
        print(L)
    elif (setting == 3):
        print(" ================================================ \n",
              "Modul 4 Integrasi Numerik: Metode Simpson 1/3 \n",
              "KELOMPOK 10 \n",
              "OSEANOGRAFI 2019 \n",
              "PRAKTIKUM METODE NUMERIK 2021 \n"
              "================================================ \n")
...
def modul_5():
    ...
    def euler():
        ...
        xn = float(input("Masukkan nilai x akhir: ")) #Untuk x akhir ketentuan 2 nim akhir dibalik (nilainya 2,0)
        ...
        plt.plot(x, y, 'b--', 'r', label='Hasil Pendekatan')
        plt.plot(x, G, '-g', 'y', label='Hasil Analitik')
        plt.title(judul) #Judul Plot
        plt.xlabel('x') #Label u/ sumbu x
        plt.ylabel('F(x)') #Label u/ sumbu y
        plt.grid() #u/ menampilkan grid
        plt.legend(loc='lower right')
        plt.savefig('C:/Kelompok 10/Images/Euler.png')
    # Metode Heun
    def heun():
        Nama = (input("Masukkan Nama: "))
        Nim = (input("Masukkan NIM: "))
        ...
        plt.grid() #u/ menampilkan grid
        plt.legend(loc='lower right')
        plt.savefig('C:/Kelompok 10/Images/Heun.png')
...
if (setting == 1):
    ...
    print("Lord Said: Diperiksa lagi yang diminta!")
